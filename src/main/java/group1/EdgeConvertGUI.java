...
public class EdgeConvertGUI {
    ...
    private static FileFilter effEdge, effSave, effClass;
    ...
    public void createDTScreen() {//create Define Tables screen
        jfDT = new JFrame(Constants.DEFINE_TABLES);
        jfDT.setLocation(Constants.HORIZ_LOC, Constants.VERT_LOC);
        ...
        jfDT.setSize(Constants.HORIZ_SIZE + 150, Constants.VERT_SIZE);
        ...
        jmiDTOpenEdge = new JMenuItem("Open EdgeStrategy File");
        ...
        effEdge = new group1.Util.FileFilter("edg", "EdgeStrategy Diagrammer Files");
        effSave = new FileFilter("sav", "EdgeStrategy Convert Save Files");
        ...
        jbDTDefineRelations = new JButton(Constants.DEFINE_RELATIONS);
        ...
        jlDTTablesAll.addListSelectionListener(lse -> {
        ...
        jlDTFieldsTablesAll.addListSelectionListener(lse -> {
        ...
        jbDTMoveUp.setEnabled(false);
        jbDTMoveUp.addActionListener(ae -> {
        ...
        jbDTMoveDown.setEnabled(false);
        jbDTMoveDown.addActionListener(ae -> {
    ...
    public void createDRScreen() {
        ...
        jfDR = new JFrame(Constants.DEFINE_RELATIONS);
        jfDR.setSize(Constants.HORIZ_SIZE, Constants.VERT_SIZE);
        jfDR.setLocation(Constants.HORIZ_LOC, Constants.VERT_LOC);
        ...
        jmiDROpenEdge = new JMenuItem("Open EdgeStrategy File");
        ...
        jlDRFieldsTablesRelations.addListSelectionListener(lse -> {
        ...
        jlDRTablesRelatedTo.addListSelectionListener(lse -> {
        ...
        jlDRFieldsTablesRelatedTo.addListSelectionListener(lse -> {
        ...
        jbDRDefineTables = new JButton(Constants.DEFINE_TABLES);
    ...
    private void saveAs() {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            jfDT.setTitle(Constants.DEFINE_TABLES + " - " + truncatedFilename);
            jfDR.setTitle(Constants.DEFINE_RELATIONS + " - " + truncatedFilename);
        } else {
            return;
        }
        writeSave();
    ...
    private String getSQLStatements() {
        ...
        return getSQLString(databaseName);
    }
    ...
    class CreateDDLButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent ae) {
            while (outputDir == null) {
                JOptionPane.showMessageDialog(null, "You have not selected a path that contains valid Outputs definition files yet.\nPlease select a path now.");
                setOutputDir();
            }
            ...
            if (sqlString.equals(Constants.CANCELLED)) {
                return;
            }
            writeSQL(sqlString);
        }
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if ((ae.getSource() == jmiDTOpenEdge) || (ae.getSource() == jmiDROpenEdge)) {
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    Database database = FileParser.openFile(parseFile);
